...
const fields=['clear_height','office_sf','lease_area','year_built','loading',...flags];
...
const labels={clear_height:'Clear height',clear_height_ft:'Clear height',office_sf:'Office SF',lease_area:'Available lease SF',year_built:'Year built',loading:'Loading',class_a:'Class A',heavy_power:'Heavy power',has_rail:'Has rail',has_truckwell_or_dock:'Has truckwell or dock'};
