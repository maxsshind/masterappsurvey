...
root = Path.cwd()
files = ['manifest.json','config.js','supabase.js','background.js','panel.html','panel.js','panel.css','layout.js','survey-fields.js','survey-rent.js','survey-spaces.js','survey-flyers.js','comp-property-fields.js','comp-flyer.js','comp-listing.js','comp-flyer-background.js','icons/icon16.png','icons/icon48.png','icons/icon128.png']
manifest = json.loads((root/'manifest.json').read_text())
assert manifest['manifest_version'] == 3
assert manifest['version'] == '1.4.16', 'Manifest differs from the prepared candidate version.'
