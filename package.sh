...
root = Path.cwd()
files = ['manifest.json','config.js','supabase.js','background.js','panel.html','panel.js','panel.css','layout.js','survey-fields.js','survey-rent.js','survey-spaces.js','survey-flyers.js','comp-property-fields.js','icons/icon16.png','icons/icon48.png','icons/icon128.png']
